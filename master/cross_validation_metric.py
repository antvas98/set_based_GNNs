...
def cross_validation(transformed_data,
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(splits):
        ...
        performance.append(hyperparameter_selection_within_fold(train_folds, test_fold, batch_size=batch_size, combinations=combinations, aggregators=aggregators, epochs = epochs))
